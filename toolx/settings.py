...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'toolx.context_processors.unread_messages', 
            ],
        },
    },
]
...
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_PASS')  # the 16-char app password
DEFAULT_FROM_EMAIL  = os.getenv('EMAIL_SEFLT')
...
SITE_URL = 'https://meredith-heartaching-unpoignantly.ngrok-free.dev/'